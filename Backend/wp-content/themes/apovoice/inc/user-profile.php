    ...
    <table class="form-table">
        <tr>
            ...
            <input
                    ...
                    type="text"
                    name="pharmacyName"
                    value="<?php echo $expertOnlyPharmacies_sorted['pharmacyName'] ?>"
                >
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <input
                    ...
                    type="text"
                    name="pharmacyStreet"
                    value="<?php echo $expertOnlyPharmacies_sorted['pharmacyStreet'] ?>"
                >
            </td>
        </tr>
        <tr>
            ...
            <input
                    id="pharmacyStreetNo"
                    type="text"
                    name="pharmacyStreetNo"
                    value="<?php echo $expertOnlyPharmacies_sorted['pharmacyStreetNo'] ?>"
                >
            </td>
        </tr>
        <tr>
            ...
            <input
                    ...
                    value="<?php echo $expertOnlyPharmacies_sorted['pharmacyZipCode'] ?>"
                >
            </td>
        </tr>
        <tr>
            ...
            <input
                    ...
                    type="text"
                    name="pharmacyCity"
                    value="<?php echo $expertOnlyPharmacies_sorted['pharmacyCity'] ?>"
                >
            </td>
        </tr>
    </table>
    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <input
                    id="pun"
                    type="text"
                    name="registered_pharmacy_unique_number"
                    value="<?php echo $pun_arr[$upun]->pharmacy_unique_number ?>"
                >
            </td>
        </tr>
        <?php } ?>
        ...
        <tr>
            ...
            <td>
                <label for="form_of_address_mrs">
                    <input
                        id="form_of_address_mrs"
                        type="radio"
                        name="form_of_address"
                        value="mrs"
                        <?php checked( $form_of_address === 'mrs' ) ?>
                    >
                ...
                <label for="form_of_address_mr">
                    <input
                        id="form_of_address_mr"
                        type="radio"
                        name="form_of_address"
                        value="mr"
                        <?php checked( $form_of_address === 'mr' ) ?>
                    >
        ...
        <tr>
            ...
            <td>
                ...
                >
                    <option
                        value="dr.dr."
                        <?php selected($title === 'dr.dr.') ?>
                    >
                        Dr. Dr.
                    </option>
                    <option
                        value="dr.med.dent."
                        <?php selected($title === 'dr.med.dent.') ?>
                    >
                        Dr. med. Dent.
                    </option>
                </select>
        ...
        <tr>
            ...
            <td>
                <input
                    ...
                    name="working_since"
                    id="working_since"
                    value="<?= ( isset( $_POST['working_since'] ) && ! empty( $_POST['working_since'] ) ) ? esc_html( $_POST['working_since'] ) : esc_html( $working_since ) ?>"
                >
            </td>
        </tr>
        <!-- Age -->
        <tr>
            ...
            <td>
                ...
                >
                    ...
                    <option
                        value="25 - 34"
                        <?php selected( $age === '25 - 34' ) ?>
                    >
                        18 - 25
                    </option>
                    <option
                        value="35 - 44"
                        <?php selected( $age === '35 - 44' ) ?>
                    >
                        26 - 35
                    </option>
                    <option
                        value="45 - 54"
                        <?php selected( $age === '45 - 54' ) ?>
                    >
                        36 - 50
                    </option>
                    <option
                        value="55 - 64"
                        <?php selected( $age === '55 - 64' ) ?>
                    >
                        51 - 65
                    </option>
                    <option
        ...
        <tr>
            ...
            <td>
                ...
                >
                    <option
                        value="consulting"
                        <?php selected( in_array( 'consulting', $priorities ) ) ?>
                    >
                        <?php esc_html_e( 'Consulting', 'apovoice' ) ?>
                    </option>
                    <option
                        value="purchasing"
                        <?php selected( in_array( 'purchasing', $priorities ) ) ?>
                    >
                        <?php esc_html_e( 'Purchasing', 'apovoice' ) ?>
                    </option>
                    <option
                        value="productmanagement"
                        <?php selected( in_array( 'productmanagement', $priorities ) ) ?>
                    >
                        <?php esc_html_e( 'Productmanagement', 'apovoice' ) ?>
                    </option>
                    <option
                        value="others"
                        <?php selected( in_array( 'others', $priorities ) ) ?>
                    >
        ...
        <tr>
            ...
            <td>
                ...
                >
                    <option
                        value="none"
                        <?php selected( in_array( 'none', $tasks ) ) ?>
                    >
                        <?php esc_html_e( 'None', 'apovoice' ) ?>
                    </option>
                    <option
                        value="purchasing"
                        <?php selected( in_array( 'purchasing', $tasks ) ) ?>
                    >
                        <?php esc_html_e( 'Purchasing', 'apovoice' ) ?>
                    </option>
                    <option
                        value="nutrition"
                        <?php selected( in_array( 'nutrition', $tasks ) ) ?>
                    >
                        <?php esc_html_e( 'Nutrition', 'apovoice' ) ?>
                    </option>
                    <option
                        value="homeopathy"
                        <?php selected( in_array( 'homeopathy', $tasks ) ) ?>
                    >
                        <?php esc_html_e( 'Homeopathy', 'apovoice' ) ?>
                    </option>
                    <option
                        value="pain"
                        <?php selected( in_array( 'pain', $tasks ) ) ?>
                    >
                        <?php esc_html_e( 'Pain', 'apovoice' ) ?>
                    </option>
                    <option
                        value="elderly_people"
                        <?php selected( in_array( 'elderly_people', $tasks ) ) ?>
                    >
                        <?php esc_html_e( 'Elderly people', 'apovoice' ) ?>
                    </option>
                    <option
                        value="mother_and_child"
                        <?php selected( in_array( 'mother_and_child', $tasks ) ) ?>
                    >
                        <?php esc_html_e( 'Mother and child', 'apovoice' ) ?>
                    </option>
                    <option
                        value="vitamins"
                        <?php selected( in_array( 'vitamins', $tasks ) ) ?>
                    >
