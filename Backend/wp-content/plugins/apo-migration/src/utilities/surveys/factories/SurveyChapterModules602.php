...
class SurveyChapterModules602 extends AbstractSurveyChapterModuleFactory 
{
    
    /**
     * Creates a new instance of SurveyChapterModules602
    */
    ...
    public function generateModules()
    {
        $this->addModule('text-paragraph', 
            'Danke für Deine Teilnahme am Kytta® eTraining.', 
            1)
            ->addModule('rating', [
