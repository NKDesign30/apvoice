...
class SurveyChapterModules1014 extends AbstractSurveyChapterModuleFactory 
{
    
    /**
     * Creates a new instance of SurveyChapterModules1014
    */
    ...
    public function generateModules()
    {
        $this->addModule('text-paragraph', 
                'Danke für Deine Teilnahme am VIGANTOLVIT® Vitamin D3, K2 und Calcium eTraining 2019.', 
            1)
            ->addModule('rating', [
