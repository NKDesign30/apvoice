...
class SurveyChapterModules1196 extends AbstractSurveyChapterModuleFactory 
{
    
    /**
     * Creates a new instance of SurveyChapterModules1196
    */
    ...
    public function generateModules()
    {
        $this->addModule('text-paragraph', 
                'Danke für Deine Teilnahme am WICK eTraining – VapoRub. Bitte beantworte die nachfolgenden Fragen.', 
            1)
            ->addModule('rating', [
