...
class SurveyChapterModules455 extends AbstractSurveyChapterModuleFactory 
{
    
    /**
     * Creates a new instance of SurveyChapterModules455
    */
    ...
    public function generateModules()
    {
        $this->addModule('text-paragraph', 
            'Wir haben ein paar allgemeine Fragen an Dich zu Deinen Erfahrungen in der täglichen Kundenberatung rund um das Thema Vitamin D.', 
            1)
            ->addModule('rating', [
            ...
            ->addModule('answer-single-line', [
                'question' => 'Hast du ein Produkt, das du im Bereich Vitamin D am häufigsten empfiehlst? Wenn ja, welches und warum?',
            ], 6);
