...
class SurveyChapterModules1198 extends AbstractSurveyChapterModuleFactory 
{
    
    /**
     * Creates a new instance of SurveyChapterModules1198
    */
    ...
    public function generateModules()
    {
        $this->addModule('text-paragraph', 
                'Danke für Deine Teilnahme am WICK eTraining – WICK DayMed Kombi.', 
            1)
            ->addModule('rating', [
