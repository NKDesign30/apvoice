...
class SurveyChapterModules457 extends AbstractSurveyChapterModuleFactory 
{
    
    /**
     * Creates a new instance of SurveyChapterModules457
    */
    ...
    public function generateModules()
    {
        $this->addModule('text-paragraph', 
            'Wir haben ein paar allgemeine Fragen an Dich zu Deinen Erfahrungen in der täglichen Kundenberatung mit Nasensprays/-tropfen.', 
            1)
            ->addModule('rating', [
            ...
            ->addModule('answer-single-line', [
                'question' => 'Hast du eine „Standardempfehlung“ im Bereich Nasensprays/-tropfen? Wenn ja, welche und warum?',
            ], 6);
