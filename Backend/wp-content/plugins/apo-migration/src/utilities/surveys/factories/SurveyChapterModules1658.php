...
class SurveyChapterModules1658 extends AbstractSurveyChapterModuleFactory 
{
    
    /**
     * Creates a new instance of SurveyChapterModules1658
    */
    ...
    public function generateModules()
    {
        $this->addModule('text-paragraph', 
                'Danke für Deine Teilnahme am eTraining zu WICK MediNait. Wir möchten Dir gern ein paar Fragen stellen um die Inhalte noch besser auf Deine Bedürfnisse anzupassen.', 
            1)
            ->addModule('rating', [
