...
class SurveyChapterModules1781 extends AbstractSurveyChapterModuleFactory 
{
    
    /**
     * Creates a new instance of SurveyChapterModules1781
    */
    ...
    public function generateModules()
    {
        $this->addModule('text-paragraph', 
                'Vielen Dank, dass Du das eTraining zu Nasivin® erfolgreich absolviert hast. Wir würden Dir gern ein paar Fragen zu Deinen Erfahrungen mit diesem eTraining stellen.', 
            1)
            ->addModule('rating', [
