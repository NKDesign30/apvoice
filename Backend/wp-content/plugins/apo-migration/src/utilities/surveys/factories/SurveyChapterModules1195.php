...
class SurveyChapterModules1195 extends AbstractSurveyChapterModuleFactory 
{
    
    /**
     * Creates a new instance of SurveyChapterModules1195
    */
    ...
    public function generateModules()
    {
        $this->addModule('text-paragraph', 
                'Danke für Deine Teilnahme am WICK eTraining zum Thema Erkältungen. Bitte nimm Dir kurz Zeit, die nachfolgenden Fragen zu beantworten.', 
            1)
            ->addModule('rating', [
