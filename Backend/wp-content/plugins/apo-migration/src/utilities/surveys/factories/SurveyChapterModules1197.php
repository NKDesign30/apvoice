...
class SurveyChapterModules1197 extends AbstractSurveyChapterModuleFactory 
{
    
    /**
     * Creates a new instance of SurveyChapterModules1197
    */
    ...
    public function generateModules()
    {
        $this->addModule('text-paragraph', 
                'Danke für Deine Teilnahme am WICK eTraining – WICK DayNait. Wir möchten Dir gern ein paar Fragen stellen, um die Inhalte noch besser auf Deine Bedürfnisse anzupassen.', 
            1)
            ->addModule('rating', [
