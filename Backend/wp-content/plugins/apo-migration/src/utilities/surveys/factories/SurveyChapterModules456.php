...
class SurveyChapterModules456 extends AbstractSurveyChapterModuleFactory 
{
    
    /**
     * Creates a new instance of SurveyChapterModules456
    */
    ...
    public function generateModules()
    {
        $this->addModule('text-paragraph', 
            'Wir haben ein paar allgemeine Fragen an Dich zu Deinen Erfahrungen in der täglichen Kundenberatung rund um das Thema Schwangerschaftsvitamine.', 
            1)
            ->addModule('rating', [
            ...
            ->addModule('answer-single-line', [
                'question' => 'Hast du eine „Standardempfehlung“ im Bereich Schwangerschaftsvitamine? Wenn ja, welche und warum?',
            ], 6);
