...
class SurveyChapterModules1013 extends AbstractSurveyChapterModuleFactory 
{
    
    /**
     * Creates a new instance of SurveyChapterModules1013
    */
    ...
    public function generateModules()
    {
        $this->addModule('text-paragraph', 
                'Danke für Deine Teilnahme am VIGANTOLVIT® Training.', 
            1)
            ->addModule('rating', [
            ...
            ->addModule('text-paragraph', 
                'Wenn Du die vorherige Frage „Hast Du durch die Schulung zusätzliche Erkenntnisse für deine tägliche Arbeit in der Apotheke gewonnen?“ mit „Ja“ beantwortet hast, beantworte bitte diese Fragen. Ansonsten klicke auf „Weiter“', 
            4)
            ->addModule('single-choice', [
