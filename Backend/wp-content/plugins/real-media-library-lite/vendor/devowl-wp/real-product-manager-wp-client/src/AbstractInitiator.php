...
abstract class AbstractInitiator {
    ...
    public function getPluginUpdater() {
        if ($this->pluginUpdate === null) {
            $this->pluginUpdate = \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\PluginUpdate::instance(
                $this
            );
        }
    ...
    public function start() {
        \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\Core::getInstance()->addInitiator($this);
    }
    // Self-explaining
