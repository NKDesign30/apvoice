...
class LicenseActivation {
    ...
    protected function getClientProperties() {
        return [
            [
                'key' => 'hostname',
                'value' => \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\Utils::getCurrentHostname()
            ],
    ...
    public static function instance($pluginUpdate) {
        return new \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\client\LicenseActivation(
            $pluginUpdate
        );
    }
}
