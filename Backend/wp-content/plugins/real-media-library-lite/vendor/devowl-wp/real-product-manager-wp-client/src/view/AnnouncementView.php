...
class AnnouncementView {
            ...
            \sprintf(
                ...
                add_query_arg(
                    ...
                    \sprintf(
                        ...
                        \MatthiasWeb\RealMediaLibrary\Vendor\MatthiasWeb\Utils\Service::getUrl(
    ...
    public static function instance($pool) {
        return new \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\view\AnnouncementView($pool);
    }
}
