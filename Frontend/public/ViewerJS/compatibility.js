...
(function checkRangeRequests() {
  ...
  const isChromeWithRangeBug = /Chrome\/(39|40)\./.test(navigator.userAgent);
...
(function checkFullscreenSupport() {
  const isEmbeddedIE = (navigator.userAgent.indexOf('Trident') >= 0
