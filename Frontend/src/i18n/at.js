...
export default {
  ...
  general: {
    ...
    expertPoints: '{0} Experten-Punkte',
    finish: 'Abschließen',
    apoCoins: 'Experten-Punkte',
    apoPoints: 'ApoPoints',
    next: 'Weiter',
  ...
  // Survey translations
  surveys: {
    salutation: 'Willkommen zurück, <b>{0}</b>',
    all: 'Alle Umfragen',
  ...
  trainings: {
    ...
    overview: {
      ...
      message: 'Mit unseren multimedialen eTrainings wollen wir Dir helfen, Dein Wissen zu verschiedenen Themen zu erweitern. Dafür gibt es jeweils unterschiedliche Module, an deren Ende ein Wissens-Quiz auf Dich wartet. Nach erfolgreichem Abschluss erhältst du ein apovoice-Zertifikat. Viel Erfolg!',
      submessage: '',
  ...
  // Login page
    login: {
      intro: 'Herzlich willkommen auf apovoice, <br><strong>der exklusiven Community</strong><br>für Fachkräfte im Apotheken Bereich.',
    ...
    userActivation: {
      ...
      secondParagraph: 'Du kannst sofort mit den ersten eTrainings starten und mit jeder Teilnahme an einer Umfrage wertvolle Experten-Punkte sammeln.',
    ...
    profile: {
      ...
      yourExpertPoints: 'Deine<br class="tablet:hidden"> Experten-Punkte',
    ...
    redeem: {
      ...
      error:{
        text: 'put your message here for "at"'
      },
      noVouchers: 'Momentan stehen Ihnen keine Aktionscodes zur Verfügung. Wenn Sie bereits 50 ApoCoins haben, tauschen Sie sie gegen einen ein.',

      headlines: {
        redeemExpertPoints: 'Experten-Punkte einlösen',
        expertPoints: 'Experten-Punkte',
      ...
      hint: {
        ...
        hasNotEnoughPoints: 'Du brauchst noch <b>{points} Experten-Punkte </b>, um einen Gutschein zu erhalten.',
        isPendingState: 'Nach Überprüfung Deiner Registrierung kannst Du hier Deine Experten-Punkte in Gutscheine einlösen.',
      },
      ...
      notifications: {
        success: 'Du hast erfolgreich {points} Experten-Punkte in den Coupon {voucherCode} eingelöst.',
  ...
  errors: {
    not_enough_points: 'Du hast nicht ausreichend Experten-Punkte für diese Handlung.',
  ...
  welcome: {
    ...
    latest_products: 'Neueste Produkt-eTrainings',
  ...
  redeem: {
    welcome: 'Willkommen',
    redeem_title: 'Löse hier Deine Experten-Punkte ein.',
    your: 'Deine',
    redeem: 'Einlösen',
